...
describe('fx', function () {
    it('should support providing a DOM element', function () {
        ...
        (0, _chai.expect)(anim.getElement()).to.equal(el);
    });

    it('should support providing a CSS selector string', function () {
        var anim = (0, _fx2.default)('#animation-element');
        (0, _chai.expect)(anim.getElement()).to.equal(document.querySelector('#animation-element'));
    });
});
